...
package com.wxj.o.cache.policy;
...
import com.wxj.o.db.CacheManager;
import com.wxj.o.exception.HttpException;
import com.wxj.o.model.Response;
import com.wxj.o.request.base.Request;
import com.wxj.o.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        O.getInstance().getDelivery().post(run);
    }
