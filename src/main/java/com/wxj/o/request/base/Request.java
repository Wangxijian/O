...
import com.wxj.o.O;
import com.wxj.o.adapter.AdapterParam;
import com.wxj.o.adapter.CacheCall;
import com.wxj.o.adapter.Call;
import com.wxj.o.adapter.CallAdapter;
import com.wxj.o.cache.CacheEntity;
import com.wxj.o.cache.policy.CachePolicy;
import com.wxj.o.callback.Callback;
import com.wxj.o.convert.Converter;
...
public abstract class Request<T, R extends Request> implements Serializable {
    ...
    public okhttp3.Call getRawCall() {
        ...
        if (client == null) client = O.getInstance().getOkHttpClient();
